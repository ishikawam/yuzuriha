...
var mtCookieDomain = ".be-smile-presents.net";
var mtCookiePath = "/";
...
function mtCommentOnSubmit(f) {
    if (!mtRequestSubmitted) {
        ...
        if (f.armor)
            f.armor.value = 'c02437ee30ad36196f307193e2b012be38067f79';
...
function mtSignIn() {
    ...
    if (is_preview) {
        if ( document['comments_form'] ) {
            ...
            url += '&return_url=http%3A%2F%2Fbe-smile-presents.net%2Fevent%2F100307%2F';
        }
    } else {
